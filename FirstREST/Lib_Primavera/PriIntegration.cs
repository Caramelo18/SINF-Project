...
namespace FirstREST.Lib_Primavera
{
    public class PriIntegration
    {
        ...
        public static Model.DocCompra DocCompra(string id)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                objListCab = PriEngine.Engine.Consulta("SELECT id, NumDocExterno, Entidade, DataDoc, NumDoc, TotalMerc, Serie From CabecCompras where TipoDoc='VGR' AND NumDoc='" + id + "'");
                while (!objListCab.NoFim())
                {
                    dc = new Model.DocCompra();
                    dc.id = objListCab.Valor("id");
        ...
        public static List<Model.DocCompra> VGR_List(string period)
        {
            StdBELista objListCab;
            StdBELista objListLin;
            Model.DocCompra dc = new Model.DocCompra();
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                objListCab = PriEngine.Engine.Consulta("SELECT id, NumDocExterno, Entidade, DataDoc, NumDoc, TotalMerc, Serie From CabecCompras where TipoDoc='VGR' AND DATEDIFF(month, DataDoc," + currDate + ") < '" + queryPeriod + "'");
                while (!objListCab.NoFim())
                {
                    dc = new Model.DocCompra();
                    dc.id = objListCab.Valor("id");
        ...
        public static List<Model.DocCompra> Compras_Produto_List(string producto, string period)
        {
            StdBELista objListCab;
            StdBELista objListLin;
            Model.DocCompra dc = new Model.DocCompra();
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                while (!objListCab.NoFim())
                {
                    ...
                    while (!objListLin.NoFim())
                    {
                        ...
                        if (objListLin.Valor("Artigo") == producto)
                            product = true;
        ...
        public static List<Model.DocVenda> Encomendas_Produto_List(string producto, string period)
        {
        ...
        public static Model.DocVenda Encomenda_Get(string numdoc)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                ...
                dv = new Model.DocVenda();
                dv.id = objListCab.Valor("id");
                dv.Entidade = numdoc;// objListCab.Valor("Entidade");
                dv.NumDoc = objListCab.Valor("NumDoc");
                dv.Data = objListCab.Valor("Data");
                dv.TotalMerc = objListCab.Valor("TotalMerc");
                dv.Serie = objListCab.Valor("Serie");
        ...
        public static List<Model.DocVenda> Encomendas_Cliente_List(string cliente)
        {
            ...
            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                objListCab = PriEngine.Engine.Consulta("SELECT id, Entidade, Data, NumDoc, TotalMerc, Serie From CabecDoc where TipoDoc='ECL' AND Entidade='" + cliente +"'");
                while (!objListCab.NoFim())
                {
                    dv = new Model.DocVenda();
                    dv.id = objListCab.Valor("id");
        ...
        public static List<Model.DocVenda> Encomendas_List(string period)
        {
            StdBELista objListCab;
            StdBELista objListLin;
            Model.DocVenda dv = new Model.DocVenda();
        ...
        public static List<Model.Fornecedor> SupplierList()
        {
            StdBELista objList;

            List<Model.Fornecedor> listFornecedor = new List<Model.Fornecedor>();

            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                objList = PriEngine.Engine.Consulta("SELECT Fornecedor, Nome, NomeFiscal, NumContrib, Tel FROM  FORNECEDORES");

                while (!objList.NoFim())
                {
                    listFornecedor.Add(new Model.Fornecedor
                    {
                        CodFornecedor = objList.Valor("Fornecedor"),
                        Nome = objList.Valor("Nome"),
                        NomeFiscal = objList.Valor("NomeFiscal"),
                        Contribuinte = objList.Valor("NumContrib"),
        ...
        public static Model.Fornecedor GetSupplier(string id)
        {
            StdBELista objList;

            Model.Fornecedor fornecedor = null;

            if (PriEngine.InitializeCompany(FirstREST.Properties.Settings.Default.Company.Trim(), FirstREST.Properties.Settings.Default.User.Trim(), FirstREST.Properties.Settings.Default.Password.Trim()) == true)
            {
                objList = PriEngine.Engine.Consulta("SELECT Fornecedor, Nome, NomeFiscal, NumContrib, Tel FROM  FORNECEDORES WHERE Fornecedor = '" + id + "'");
